...
init(params) {
    ...
    res = game_data['utils'].generate_string({'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '3', 'values': [], 'base_size': 55});
	...
	let sad = new Phaser.GameObjects.Image(this.scene, 0, -10, 'common1', 'btn_fail');
	this.add(sad);
